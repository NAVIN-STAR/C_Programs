...
int call()
{
    int o1, o2, o3, o4, o5, o6, o7, o8, o9, o10, o11, o12, o13, o14, o15, o16, o17, o18, o19, o20; ///these are options
    char pass[32], password[] = {"password"};
    for (;;)
    {
...
int main()
{
    ...
    printf("\t\tNabin Acharya\n");
    printf("\t\tNikhil Kumar\n");
    printf("\t\tL S Sai Harika\n");
    printf("\t\tMd. Mafaaz Chandwala\n");
    printf("\t\tNisarga S Gowda\n");
    printf("\t\tKomala M C\n");
    printf("______________________________________________________________________________________________________\n\n");
    printf("------------------------------------------------------------------------------------------------------\n\n");
    call();
